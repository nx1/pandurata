...
*/
  ...
  /*printf("calc_e4 e_lf after calc_e2 \n");
  printf("%12.5e %12.5e %12.5e %12.5e\n",
		     ...
		     long irstart, double eps_th)
{
  ...
  for (ibottom=0;ibottom<=1;ibottom++) {
	...
	if (ibottom == 0) {
	   /*printf("surface tetrads ir iph %d %d \n", ir, iph);
                  printf("%12.5e %12.5e %12.5e %12.5e\n",
                         e_lf[1][1],e_lf[1][2],e_lf[1][3],e_lf[1][4]);
                  printf("%12.5e %12.5e %12.5e %12.5e\n",
                         e_lf[2][1],e_lf[2][2],e_lf[2][3],e_lf[2][4]);
                  printf("%12.5e %12.5e %12.5e %12.5e\n",
                         e_lf[3][1],e_lf[3][2],e_lf[3][3],e_lf[3][4]);
                  printf("%12.5e %12.5e %12.5e %12.5e\n",
                         e_lf[4][1],e_lf[4][2],e_lf[4][3],e_lf[4][4]);
	  */
          for (i=0;i<=3;i++) {
	    for (j=0;j<=3;j++) {
