...
void get_harm3d_data(double rr[], double tt[], double pp[], double rho_ijk[],
                     double T_ijk[], double bb_ijk[], double tau_ijk[],
  ...
  float *rho_flt, *T_flt, *bb_flt, *tau_flt, *ut_flt, *ur_flt, *uz_flt, *up_flt, *photo_flt;
  long i, j, k, ik, ih, id, iu;
  FILE *grid_file, *rho_file, *T_file, *bb_file, *tau_file, *ut_file, *ur_file, *uz_file, *up_file, *photo_file;
  char fname[100];
